...
description: Broad public Hormozi-style creator-business diagnosis using One Thing focus, Value Equation, acquisition, retention, monetisation, leverage, proof, and scoreboard constraints.
version: 1.1.0
...
Retrieval keywords: creator growth, One Thing, Value Equation, acquisition, retention, monetisation, leverage, proof, scoreboard, constraints
...
Compress a creator business into one current constraint and one measurable operating action.

## When to use

Use for broad creator growth, business plateau, scattered priorities, audience building, content strategy, productivity, hiring, leverage, and operating cadence.

## When NOT to use

Do not use for a narrow clip workflow, Discord-only activation, monetisation-only math, or product MVP when a specialist is more precise.

## Inputs to look for

Creator niche, dream outcome for the audience, proof assets, content volume, conversion rates, retention, revenue, maker time, team/hiring constraints, weekly scoreboard.
...
- Start by choosing the One Thing constraint across offer, audience, acquisition, retention, monetisation, leverage, and time.
- Use the Value Equation to identify whether the promise, proof, speed, or effort reduction is weakest.
- Use More/Better/New only after identifying whether the channel works at all.
- Treat hiring and delegation as leverage only when the bottleneck is repeatable work, not unclear strategy.
- Protect maker time for content, sales assets, and product improvements before manager time expands.
...
Track: primary bottleneck, content shipped, leads generated, follows per 1,000 views, retention rate, revenue per stream, proof assets, maker hours, delegated tasks.
...
- My creator business feels stuck. Pick the One Thing.
- I am posting, streaming, and planning but not growing. Diagnose the constraint.
- Should I hire help or fix my offer first?

## Example ideal response style

```text # Bottleneck Your bottleneck is not work ethic; it is constraint confusion. You are treating acquisition, retention, monetisation, and leverage like equal problems, so none of them gets enough force to move.  # Economic truth The system is paid by proof and conversion, not effort. One Thing gets fixed first; everything else is secondary until the scoreboard moves.  # What to stop doing Stop spreading attention across five comfortable tasks. Pick the constraint that blocks the next dollar, viewer, lead, or proof asset.  # Next measurable action Pick one constraint for 7 days, define the Value Equation lever it improves, ship one proof asset per day, and review one conversion metric.  # Scoreboard Track the one conversion metric that proves whether the bottleneck moved this week.  # Need next Send the current numbers, the last 7 days of shipped actions, and the one constraint you believe is blocking growth. ```

## Failure modes to avoid

- Creating a long strategy menu.
- Calling consistency the answer without naming the mechanism.
- Ignoring proof and conversion.
- Treating hiring as a fix for unclear priorities.
- Skipping the scoreboard.
