...
description: Creator offer, audience, positioning, title, thumbnail, promise, premium posture, Proof over Promise, and Value Equation packaging.
version: 1.1.0
...
Retrieval keywords: offer, audience, packaging, positioning, Value Equation, premium pricing, Proof over Promise, title, thumbnail, content promise
...
Make the audience promise clear, valuable, believable, fast, and low-friction enough for strangers to care.

## When to use

Use for offer critique, weak titles, unclear audience, low click-through, premium positioning, promise refinement, proof assets, and content packaging.

## When NOT to use

Do not use for live pacing, Discord rituals, clip workflow, or monetisation math unless the offer promise is the bottleneck.

## Inputs to look for

Target viewer, desired outcome, current title/thumbnail/hook, proof, niche, format, objections, price/posture, time delay, effort/sacrifice, alternatives.
...
- Use the Value Equation explicitly: dream outcome, perceived likelihood, time delay, effort/sacrifice.
- Increase premium posture by sharpening the outcome and proof, not by discounting access.
- Make content packaging prove the promise before the viewer invests time.
- Content is targeting: a strong title should repel the wrong viewer and attract the right one.
- Replace vague creator identity with a viewer-specific outcome.
...
Track: click-through rate, hook hold, follow conversion, proof assets, offer clarity, objection removed, title tests, premium conversion, time-to-value.
...
- Critique my creator offer using the Value Equation.
- Why would strangers watch my horror stream?
- Make this title and promise premium instead of generic.

## Example ideal response style

```text # Bottleneck Your bottleneck is offer clarity. The viewer has to decode the payoff, so your content feels cheaper than it is because the outcome and proof are not compressed.  # Economic truth The system is paid by proof and conversion, not effort. One Thing gets fixed first; everything else is secondary until the scoreboard moves.  # What to stop doing Stop spreading attention across five comfortable tasks. Pick the constraint that blocks the next dollar, viewer, lead, or proof asset.  # Next measurable action Rewrite the promise around one viewer outcome, attach one proof asset, remove one effort objection, and test three titles against click-through.  # Scoreboard Track the one conversion metric that proves whether the bottleneck moved this week.  # Need next Send the current numbers, the last 7 days of shipped actions, and the one constraint you believe is blocking growth. ```

## Failure modes to avoid

- Making the creator the offer instead of the viewer outcome.
- Using clever wording that hides the payoff.
- Discounting instead of improving proof.
- Ignoring time delay and effort/sacrifice.
- Writing titles that target nobody.
